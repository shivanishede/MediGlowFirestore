                                ...
                                <tr key={txn.id}>
                                    ...
                                    <td>
                                        <div className="action-btns" style={{ justifyContent: 'center' }}>
                                            ...
                                            {(activeTab === 'payment_in' || ((['sale', 'estimate', 'sale_return', 'delivery_challan', 'sale_order'].includes(activeTab)) && (txn.balance || 0) > 0)) && (
                                            ...
                                            {(activeTab === 'sale' || activeTab === 'estimate' || activeTab === 'payment_in' || activeTab === 'sale_return' || activeTab === 'delivery_challan' || activeTab === 'sale_order') && (
